...
public class Api_LearnLogTest {
    ...
    public void testGetLearnLog(){
        ...
        Response response1=TestConfig.getOrDeleteExecu("get","/learn_log/26ff6a00c9a6fcdb67db048fb164184a?school_code=buaaa");
        response1.then().
        ...
        Response response2=TestConfig.getOrDeleteExecu("get","/learn_log/26ff6a00c9a6fcdb67db048fb164184a?school_code=buaa");
        response2.then().
                assertThat().statusCode(200).
                body("data.course_name", Matchers.hasItems("编程入门基础")).
                body("data.size", Matchers.lessThan(5));
